package sg.edu.rp.c346.id21023395.demosimplelistviewexamtips;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        examTipsArray = new String[]{"Don't just read the code, code it as much as possible during each practical session",
